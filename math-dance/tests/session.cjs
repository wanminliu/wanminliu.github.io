...
get('duration').value='120';get('level').value='1';get('volume').value='45';get('accelerate').checked=true;get('formula-toggle').checked=true;get('speech').checked=true;get('jumps').checked=true;get('relations').checked=true;
